...
_G.packer_plugins = {
  ...
  ["nabla.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/luka/.local/share/nvim/site/pack/packer/opt/nabla.nvim",
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'TrueZen.nvim', 'vim-markdown', 'nabla.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
