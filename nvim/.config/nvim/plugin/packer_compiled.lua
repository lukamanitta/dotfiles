...
_G.packer_plugins = {
  ...
  ["cmp-tabnine"] = {
    loaded = true,
    path = "/Users/lukamanitta/.local/share/nvim/site/pack/packer/start/cmp-tabnine",
    url = "https://github.com/tzachar/cmp-tabnine"
  },
  ["hop.nvim"] = {
    config = { "\27LJ\2\n+\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\16plugins.hop\frequire\0" },
    loaded = true,
    path = "/Users/lukamanitta/.local/share/nvim/site/pack/packer/start/hop.nvim",
  ...
  ["lazygit.nvim"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/Users/lukamanitta/.local/share/nvim/site/pack/packer/opt/lazygit.nvim",
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'TrueZen.nvim', 'vim-markdown'}, { ft = "markdown" }, _G.packer_plugins)]]
